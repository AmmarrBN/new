...
# Fixed By Powerr-Python (Perbaikan Eror)
# Fixed Take 2 By AmmarrBN (Penambahan Web Spam,Logo)
...
# Fixed By Powerr-Python (Perbaikan Eror)
# Fixed Take 2 By AmmarrBN (Penambahan Web Spam)
# Powered Executed-Team
# Fixed Take 3 By Powerr-Python (Penghapusan Jumlah Spam)
# Fixed Take 3 By Powerr-Python (Pnambahan try agar Meningkatkan Performa Jaringan)
# </> Last Time Fixed: Thursday/26/05/2022 </>
# ---------------------------------------------------------------------------------
try:
	def spammer():
		try:
			...
			dat=json.dumps({"name":"AmmarExecuted","email":mail,"password":"@mm4rgans","phone":"+62"+nomor,"phone_format":nomor,"name_toko":"","url_id":"","business_type_id":"","service_type_id":3,"country_id":"ID","city_id":"","state_id":"","pos_resto_mode":0,"i_agree":"true","address":"","id":"null","tokenMiscall":"","use_otp_type":2})
